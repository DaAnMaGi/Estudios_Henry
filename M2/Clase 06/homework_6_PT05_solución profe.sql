/*
1. Inserte los siguientes registros dentro de la base de datos creada en la clase anterior, 
...
INSERT 
	instructor (cedulaIdentidad, nombre, apellido, fechaNacimiento, fechaIncorporacion) 
VALUES 
...
INSERT INTO 
	cohorte 
VALUES 
	(1235,'FT-1235',1,1,'2020-2-1','2020-6-30'),
...
INSERT INTO 
	cohorte (codigo, idCarrera, idInstructor, fechaInicio, fechaFinalizacion)
VALUES 
	('FT-1235',1,1,'2020-2-1','2020-6-30');

select * from cohorte;

-- ALUMNO
INSERT INTO 
	alumno (idAlumno,cedulaIdentidad,nombre,apellido,fechaNacimiento,fechaIngreso,idCohorte)
VALUES 
	(1,'274352477','Candice','Rojas','2000-12-10','2020-01-21', 1235);
...
INSERT INTO 
	alumno (idAlumno,cedulaIdentidad,nombre,apellido,fechaNacimiento,fechaIngreso,idCohorte)
VALUES 
	(2,'313262855','Beverly','Gardner','2006-10-03','2019-12-04',1235),
...
INSERT INTO 
	alumno (idAlumno,cedulaIdentidad,nombre,apellido,fechaNacimiento,fechaIngreso,idCohorte)
VALUES 
	(10,'19507661','Hillary','Holman','2001-04-07','2019-12-14',1235),
...
INSERT INTO 
	alumno (idAlumno,cedulaIdentidad,nombre,apellido,fechaNacimiento,fechaIngreso,idCohorte)
VALUES 
	(21,'193744389','Belle','Cervantes','2001-02-03','2020-03-17',1236),
...
-- Verificar la existencia de lo datos
select * from cohorte
...
-- Verificamos la existencia de la cohorte 1243
select * from cohorte
...
-- Verificamos la existencia del alumno 165
select * from alumno
where idAlumno = 165;
...
-- 9. La siguiente consulta permite acceder a datos de otras tablas y 
-- devolver un listado con la carrera a la cual pertenece cada alumno:
-- En el M3 profudizaremos en el aprendizaje de SQL, pero aprovechemos 
-- lo que sabemos hasta aquí para entender como funcionan las relacionales.

SELECT 
	alumno.nombre, 
	alumno.apellido, 
	alumno.fechaNacimiento, 
	carrera.nombre as 'Nombre carrera'
FROM alumno
	INNER JOIN cohorte
...
-- b. ¿Que tipo de ralación existe entre el nombre en la tabla cohorte y alumno? 
-- 



-- c. Proponga dos opciones para filtrar el listado solo por los alumnos que pertenecen a 
-- 'Full Stack Developer', utilizando LIKE y NOT LIKE?, 
...
-- d. ¿Proponga dos opciones para filtrar el listado solo por los alumnos que pertenecen a 
-- 'Full Stack Developer', utilizando " = " y " != "? 
-- ¿Cual de las dos opciones es la manera correcta de hacerlo?, ¿Por que? 
